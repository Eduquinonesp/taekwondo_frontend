...
export default function PagosPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white px-6 py-8">
      <div className="max-w-6xl mx-auto space-y-4">
        <div>
          <h1 className="text-3xl font-bold">Gestión de Pagos</h1>
          <p className="text-sm text-slate-300 mt-1">
            Registra y controla los pagos mensuales de tus alumnos,
            con el mismo estilo del resto del sistema.
          </p>
        </div>

        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* ----- Formulario ----- */}
          <Card className="bg-slate-900/90 border border-slate-700 shadow-lg">
            <CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleCrearPago} className="space-y-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select
                    className="bg-slate-950 border border-slate-700 rounded-md px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    value={alumnoId}
                    onChange={(e) =>
                      setAlumnoId(
                ...
                {/* Mensajes */}
                {error && (
                  <p className="text-sm text-red-300 bg-red-900/30 border border-red-700 rounded-md px-3 py-2">
                    {error}
                  </p>
                )}
                {mensajeOk && (
                  <p className="text-sm text-emerald-300 bg-emerald-900/30 border border-emerald-700 rounded-md px-3 py-2">
                    {mensajeOk}
                  </p>
                )}
            ...
            <CardContent className="overflow-x-auto">
              {cargando ? (
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-left text-slate-300 border-b border-slate-700 bg-slate-950/70">
                      ...
                      >
                        ...
                        <td className="py-2 pr-2 text-right">
                          <button
                            ...
                            className="px-3 py-1 rounded-md text-xs border border-slate-600 hover:bg-slate-800"
                          >
                            {p.pagado
